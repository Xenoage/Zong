...
public class MxlScorePart
	...
	@NonNull public static MxlScorePart read(XmlReader reader, ErrorHandler errorHandler) {
		//attributes
		...
		if (partName == null && errorHandler.tryFix(reader.dataException("part-name unknown")))
			partName = "";
