...
public class BracketStampingRenderer
	...
	private static void paintBrace(BracketStamping bracket, Canvas canvas, RendererArgs args) {
		...
		canvas.drawSymbol(braceSymbol, Color.black, pCenter, new Point2f(interlineSpace * 1.2f,
			symbolScaling));
	...
	private static void paintBracket(BracketStamping bracket, Canvas canvas, RendererArgs args) {
		...
		canvas.drawSymbol(bracketLineSymbol, Color.black, p(p1Mm.x, p1Mm.y - lineYCorrection / 2),
			new Point2f(interlineSpace, lineYScaling));
		canvas.drawSymbol(bracketEndSymbol, Color.black, p1Mm, new Point2f(interlineSpace,
			-interlineSpace));
