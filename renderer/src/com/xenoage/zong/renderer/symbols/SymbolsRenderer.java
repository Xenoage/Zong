...
public abstract class SymbolsRenderer
{
   ...
   */
	public void draw(Symbol symbol, Canvas canvas, ColorInfo color,
   ...
   * with the given color at the given position and the given scaling.
   */
  public abstract void draw(PathSymbol symbol, Canvas canvas, ColorInfo color,
  	Point2f position, Point2f scaling);
   ...
   * with the given color at the given position and the given scaling.
   */
  public abstract void draw(WarningSymbol symbol, Canvas canvas, ColorInfo color,
    Point2f position, Point2f scaling);
