...
public final class CreditsReader {
	 ...
	 */
	public static Layout read(MxlScorePartwise mxlScorePartwise, Layout layout,
	...
	private static Layout plusTextFrame(MxlCredit credit, Layout layout, ScoreFormat scoreFormat) {
		...
		if (credit.getContent().getCreditContentType() == MxlCreditContentType.CreditWords) {
			...
			Point2f position = new Point2f(notNull(mxlFirstCreditWords.getPrintStyle().getPosition()
				.getDefaultX(), 10f) *
				tenths, firstPage.format.size.height -
