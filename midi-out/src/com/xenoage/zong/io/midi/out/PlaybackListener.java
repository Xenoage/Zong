...
public interface PlaybackListener
{
	 ...
	 * known {@link BMP} (e.g. where a musical element starts or ends).
	 * @param mp  the {@link BMP} musical position where the playback stopped
	 * @param ms  the position in milliseconds
	 */
	public void playbackAtMP(BMP mp, long ms);
