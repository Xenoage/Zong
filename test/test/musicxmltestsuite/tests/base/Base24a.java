...
public interface Base24a
	...
	static Chord[] getExpectedChords() {
		...
		Chord[] expectedChords = new Chord[] {
			//measure 0
			gr(Companion.fr(1, 16), false, pi('D', 0, 5)),
			ch(Companion.fr(1, 4), pi('C', 0, 5)),
			b1s = gr(Companion.fr(1, 16), false, pi('E', 0, 5)),
			b1e = gr(Companion.fr(1, 16), false, pi('D', 0, 5)),
			ch(Companion.fr(1, 4), pi('C', 0, 5)),
			gr(Companion.fr(1, 16), false, pi('D', 0, 5)),
			ch(Companion.fr(1, 4), pi('C', 0, 5)),
			gr(Companion.fr(1, 8), false, pi('D', 0, 5)),
			ch(Companion.fr(1, 4), pi('C', 0, 5)),
			//measure 1
			gr(Companion.fr(1, 16), true, pi('D', 0, 5)),
			ch(Companion.fr(1, 4), pi('C', 0, 5)),
			b2s = gr(Companion.fr(1, 16), false, pi('E', 0, 5)),
			b2e = gr(Companion.fr(1, 16), false, pi('D', 0, 5)),
			ch(Companion.fr(2, 4), pi('C', 0, 5)),
			gr(Companion.fr(1, 16), true, pi('D', 0, 5)),
			ch(Companion.fr(1, 8), pi('C', 0, 5)),
			gr(Companion.fr(1, 16), true, pi('D', 0, 5)),
			ch(Companion.fr(1, 8), pi('C', 0, 5)),
			gr(Companion.fr(1, 16), false, pi('E', 0, 5)),
			//measure 2
			gr(Companion.fr(1, 16), false, pi('E', 0, 5)),
			ch(Companion.fr(1, 4), pi('F', 0, 4), pi('C', 0, 5)),
			gr(Companion.fr(1, 4), false, pi('D', 1, 5)),
			ch(Companion.fr(1, 4), pi('C', 0, 5)),
			gr(Companion.fr(1, 4), false, pi('D', -1, 5)),
			gr(Companion.fr(1, 4), false, pi('A', -1, 4)),
			ch(Companion.fr(1, 4), pi('C', 0, 5)),
			ch(Companion.fr(1, 4), pi('C', 0, 5))
		};
