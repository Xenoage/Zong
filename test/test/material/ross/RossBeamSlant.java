...
public class RossBeamSlant {
	...
	public static class Example {
		...
		private Example width(double widthIs) {
			this.widthIs = (float) widthIs;
			return this;
		}
		
		private Example middleNotes(int... noteLps) {
			middleNotesLps = noteLps;
			return this;
		}
		
		private Example right(int noteLp, double stemLengthIs) {
			rightNoteLp = noteLp;
			rightStemLengthIs = (float) stemLengthIs;
			return this;
		}
		
		private Example stemDir(StemDirection stemDir) {
	...
	private Example example(String name) {
	...
	/**
	 * Simple example with normal spacing, like on page 104.
	 */
	private Example example(String name, int leftNoteLp, double leftStemLengthIs,
