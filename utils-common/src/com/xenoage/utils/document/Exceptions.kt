 ...
 */
class CancelledException(message: String?, cause: Throwable?) : Exception(message, cause)
 ...
 */
class PropertyAlreadySetException(message: String?, cause: Throwable?) : Exception(message, cause)
 ...
 */
class UselessException(message: String?, cause: Throwable?) : Exception(message, cause)