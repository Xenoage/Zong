...
public class Scaling
{
		...
		throws ServletException
	{
		...
		Integer heightpx = (attribute(e, "heightpx") != null ? getIntAttr(e, "heightpx")
			: null);
	...
	public static Scaling fromParams(Map<String, String[]> params)
		throws ServletException
	{
		Integer dpi = (params.get("scaling_dpi") != null ? getInt(params, "scaling_dpi")
			: null);
		Integer widthpx = (params.get("scaling_widthpx") != null ? getInt(params,
			"scaling_widthpx") : null);
		Integer heightpx = (params.get("scaling_heightpx") != null ? getInt(params,
			"scaling_heightpx") : null);
		return new Scaling(dpi, widthpx, heightpx);
	}
