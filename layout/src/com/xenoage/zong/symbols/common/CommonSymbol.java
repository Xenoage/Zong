 ...
 * by calling SymbolPool.getSymbol(CommonSymbol).
 * 
...
public enum CommonSymbol
{
	...
	public static CommonSymbol getDigit(int digit)
	{
		switch (digit)
		{
			...
			default: throw new IllegalArgumentException("digit must be a number between 0 and 9.");
		}
	}
	...
	public static CommonSymbol getArticulation(Articulation.Type type)
	{
		switch (type)
		{
			case Accent: return ArticulationAccent;
			case Staccato: return ArticulationStaccato;
			case Staccatissimo: return ArticulationStaccatissimo;
			case StrongAccent: return ArticulationStrongAccent;
			case Tenuto: return ArticulationTenuto;
			default: throw new IllegalArgumentException("unsupported articulation");
		}
	}
	...
	public static CommonSymbol getClef(ClefType clefType)
  {
	...
	public static ArrayList<CommonSymbol> getDynamics(DynamicsType dynamicsType)
	{
		...
		for (int i = 0; i < name.length(); i++)
		{
			...
			{
				case 'f': ret.add(CommonSymbol.DynamicsF); break;
				case 'm': ret.add(CommonSymbol.DynamicsM); break;
				case 'p': ret.add(CommonSymbol.DynamicsP); break;
				case 's': ret.add(CommonSymbol.DynamicsS); break;
				case 'z': ret.add(CommonSymbol.DynamicsZ); break;
			}
		}
		return ret;
	}
