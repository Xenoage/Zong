	...
	implements ScoreLayouterStrategy
{
	...
	public StemDirection computeStemDirection(Chord chord, MusicContext context)
	{
		...
		if (chord.stem != null && chord.stem.direction != null)
		{
	...
	*/
	...
	{
		int distanceLowestNoteFromMidline = Math.abs(getDistanceFromMidline(
			chordLP.getBottom(), linesCount));
		int distanceHighestNoteFromMidline = Math.abs(getDistanceFromMidline(
			chordLP.getTop(), linesCount));
