...
/**
 * Implementation of a {@link BeamLines} strategy for a single line beam (8th).
 * 
...
public class OneLine
	...
	private float totalBeamHeightIs = 0.5f;


	public OneLine(StemDirection stemDirection, int staffLinesCount) {
	...
	/**
	 * Returns the slant in Line Positions.
