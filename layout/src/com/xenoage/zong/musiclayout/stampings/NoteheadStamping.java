  ...
  extends StaffSymbolStamping
{
  ...
  {
    super(parentStaff, chord, getSymbol(notehead, symbolPool), color,
      sp(computePositionX(position.xMm, notehead, scaling, parentStaff, symbolPool), position.lp),
      scaling, false);
  }
  	...
  	StaffStamping staff, SymbolPool symbolPool)
  {
    ...
    Rectangle2f bounds;
    if (symbol != null)
      bounds = symbol.boundingRect.scale(scaling);
    else
