  ...
  extends Stamping
{
  ...
  public KeySignatureStamping(TraditionalKey traditionalKey,
    ...
    StaffStamping parentStaff, SymbolPool symbolPool, LayoutSettings layoutSettings)
  {
    super(parentStaff, Level.Music, null,
    	createBoundingShape(traditionalKey, parentStaff, linePositionC4,
    		linePositionMin, positionX, symbolPool, layoutSettings));
  	...
  	SymbolPool symbolPool, LayoutSettings layoutSettings)
  {
    ...
    float distance = (useSharps ?
    	layoutSettings.spacings.widthSharp : layoutSettings.spacings.widthFlat);
    Symbol symbol = symbolPool.getSymbol(
