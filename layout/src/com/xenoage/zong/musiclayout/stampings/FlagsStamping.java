  ...
  extends Stamping
{
	...
	/** The direction the flag. This is usually the opposite stem direction. */
  ...
  /**
   * The position of the flag. The vertical coordinate is the
    ...
    StaffStamping parentStaff, Chord chord, SP position, SymbolPool symbolPool)
  {
    super(parentStaff, Level.Music, chord,
    	createBoundingShape(flagsDirection, flagsCount, scaling, parentStaff, position, symbolPool));
