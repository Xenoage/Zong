  ...
  extends Stamping
{
	...
	//format of the staff
	public final Point2f position; //in mm
  ...
  public StaffStamping(Point2f position, float length, int linesCount, float is, StaffMarks staffMarks)
  {
    super(null, Stamping.Level.Staff, null, new Rectangle2f(position,
    	new Size2f(length, (linesCount - 1) * is /*TODO: line width! */)));
  ...
  {
    return position.y + (linesCount - 1) * is -
      lp * is / 2 + getLineWidth() / 2; 
  }
  ...
  public int getEndMeasureIndex()
	...
	/**
	 * See {@link StaffMarks#getBMP(float)}.
   * Throws an {@link IllegalStateException} if positions are unknown.
	 */
	public BMP getMPAtX(float positionX)
	{
