...
public class LayoutSettingsTest
{
	...
	@Test public void testGetWidth()
  {
    ...
    assertEquals((3+4)*((1f/3)/(3f/4)),
    	sp.getWidth(fr(1, 3)), Delta.DELTA_FLOAT_ROUGH);
    //duration 1/16 = width 1 (half of duration 1/8)
    assertEquals(1,
    	sp.getWidth(fr(1, 16)), Delta.DELTA_FLOAT_ROUGH);
    //duration 2/1 = width 12 (double of duration 1/1)
    assertEquals(12,
    	sp.getWidth(fr(2, 1)), Delta.DELTA_FLOAT_ROUGH);
	...
	public static LayoutSettings loadTestSettings()
	{
		...
		return LayoutSettings.load("data/test/layout/LayoutSettingsTest.xml");
	}
