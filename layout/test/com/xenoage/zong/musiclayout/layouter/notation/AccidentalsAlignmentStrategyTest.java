...
public class AccidentalsAlignmentStrategyTest
{
  ...
  @Test public void testNoAcc()
  {
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(0, 0),
        new NoteAlignment(3, 0), new NoteAlignment(9, 0)}, cw, contextEb);
    assertNull(caa);
  }
  ...
  @Test public void test1Acc()
  {
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(5, 0)}, cw, contextC);
    assertEquals(1, caa.getAccidentals().size());
    assertEquals(cw.doubleSharp + cw.accToNoteGap,
  ...
  @Test public void test2Acc2Notes()
  {
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(2, 0), new NoteAlignment(11, 0)}, cw, contextC);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.sharp + cw.accToNoteGap, caa.getWidth(), Delta.DELTA_FLOAT);
    //Bb4, Ab5 (p. 131)
    caa = strategy.computeAccidentalsAlignment(
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{
        new NoteAlignment(3, 0), new NoteAlignment(4, cw.quarter, susRight)},
        cw, contextC);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.flat + cw.accToAccGap + cw.flat + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    ...
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.sharp + cw.accToAccGap + cw.sharp + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    assertEquals(0f, caa.getAccidentals().get(0).getOffset(), Delta.DELTA_FLOAT);
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{
        new NoteAlignment(6, 0, susLeft), new NoteAlignment(7, cw.quarter)},
        cw, contextC);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.flat + cw.accToAccGap + cw.flat + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
  ...
  @Test public void test2Acc3Notes()
  {
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(0, 0),
        new NoteAlignment(2, 0), new NoteAlignment(5, 0)}, cw, contextAccG4);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.flat + cw.accToAccGap + cw.natural + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    assertEquals(0f, caa.getAccidentals().get(0).getOffset(), Delta.DELTA_FLOAT);
    ...
    caa = strategy.computeAccidentalsAlignment(
    	pvec(pi(2, -1, 4), pi(4, 0, 4), pi(0, 0, 5)),
      new NoteAlignment[]{new NoteAlignment(0, 0),
        new NoteAlignment(2, 0), new NoteAlignment(5, 0)}, cw, contextAccC5);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.flat + cw.accToAccGap + cw.natural + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    assertEquals(0f, caa.getAccidentals().get(0).getOffset(), Delta.DELTA_FLOAT);
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(1, 0),
        new NoteAlignment(2, cw.quarter, susRight), new NoteAlignment(6, 0)},
        cw, contextAccD5);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.natural + cw.accToAccGap + cw.sharp + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(1, 0),
        new NoteAlignment(5, 0), new NoteAlignment(6, cw.quarter, susRight)},
        cw, contextC);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.sharp + cw.accToAccGap + cw.sharp + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    ...
    caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(3, cw.quarter),
        new NoteAlignment(7, 0, susLeft), new NoteAlignment(8, cw.quarter)},
        cw, contextC);
    assertEquals(2, caa.getAccidentals().size());
    assertEquals(cw.flat + cw.accToAccGap + cw.flat + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
  ...
  @Test public void test3AccRule1()
  {
    ...
    assertEquals(cw.sharp + cw.accToAccGap + cw.sharp + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    assertEquals(cw.sharp + cw.accToAccGap, caa.getAccidentals().get(0).getOffset(), Delta.DELTA_FLOAT);
    assertEquals(-1, caa.getAccidentals().get(0).getLinePosition());
    assertEquals(0f,
      caa.getAccidentals().get(1).getOffset(), Delta.DELTA_FLOAT);
  ...
  @Test public void test3AccRule3()
  {
    ...
    AccidentalsAlignment caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(-1, 0),
        new NoteAlignment(0, cw.quarter, susRight), new NoteAlignment(5, 0)},
        cw, contextC);
    assertEquals(3, caa.getAccidentals().size());
    assertEquals(2 * (cw.sharp + cw.accToAccGap) +
  ...
  @Test public void test3AccRule5()
  {
    ...
    assertEquals(3, caa.getAccidentals().size());
    assertEquals(cw.flat + cw.accToAccGap +
      cw.natural + cw.accToAccGap +
      cw.flat + cw.accToNoteGap,
      caa.getWidth(), Delta.DELTA_FLOAT);
    assertEquals(cw.flat + cw.accToAccGap,
      caa.getAccidentals().get(0).getOffset(), Delta.DELTA_FLOAT);
    assertEquals(-1, caa.getAccidentals().get(0).getLinePosition());
  ...
  @Test public void test3AccRule6()
  {
    ...
    AccidentalsAlignment caa = strategy.computeAccidentalsAlignment(
      ...
      new NoteAlignment[]{new NoteAlignment(-1, 0),
        new NoteAlignment(0, cw.quarter, susRight), new NoteAlignment(4, 0)},
        cw, contextAccsD4B4);
    assertEquals(3, caa.getAccidentals().size());
    assertEquals(cw.natural + cw.accToAccGap +
      cw.natural + cw.accToAccGap +
