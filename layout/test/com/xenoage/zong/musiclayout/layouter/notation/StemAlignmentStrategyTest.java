...
public class StemAlignmentStrategyTest
{
	...
	private void testPitch(Pitch[] pitches, float start, float end)
	{
		...
		chordNotesAlignment = cnaStrategy.computeNotesAlignment(chord, stemDirection, ChordWidths.defaultValue, context);
		chordStemAlignment = strategy.computeStemAlignment(null, chordNotesAlignment, stemDirection, 5, 1);
