...
public class BeatOffsetBasedVoiceSpacingStrategyTest
{
  ...
  @Test public void testComputeSharedBeats()
  {
    ...
    //shared beats: 0      7 9
  	PVector<SpacingElement> list1 = pvec(
  ...
  @Test public void computeVoiceSpacingTest1()
  {
    ...
    //           | ⌎----- 2
    //           ⌎------- 1
    VoiceSpacing voiceSpacing = new VoiceSpacing(Voice.empty, is, pvec(
    ...
    BeatOffsetBasedVoiceSpacingStrategy strategy = new BeatOffsetBasedVoiceSpacingStrategy();
    Vector<SpacingElement> finalSpacing =
  ...
  @Test public void computeVoiceSpacingTestGrace()
  {
    ...
    VoiceSpacing voiceSpacing = new VoiceSpacing(Voice.empty, is, pvec(
    	new SpacingElement(null, beat(0), 0f),
      new SpacingElement(null, beat(2), 1f),
      new SpacingElement(null, beat(8), 8f, true),
      new SpacingElement(null, beat(8), 9f, true),
      new SpacingElement(null, beat(8), 10f)));
    //given beat offsets:
    //beats:   0.......8
    //offsets: |       | 
    //         |       ⌎- 30
    //         ⌎--------- 10
    PVector<BeatOffset> beatOffsets = pvec(
      new BeatOffset(beat(0), 10f),
      new BeatOffset(beat(8), 30f));
    //shared beats: 4, 8.
    //
    //resulting spacing:
    //beats:   0.2...gg8
