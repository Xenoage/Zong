...
/**
 * Test cases for a {@link PageViewManager}.
 *
...
public class PageViewManagerTest
{
  ...
  @Before public void setUp()
  {
    ...
    Layout layout = new Layout(new LayoutDefaults(LayoutFormat.defaultValue,
    	new SymbolPool(), LayoutSettings.loadDefault()));
    //3 pages:
    // ----          --------
    // |1 | -2------ |3     |
    // |  | -------- |      |
    // ----          --------
    layout = layout.plusPage(new Page(new PageFormat(new Size2f(100, 200), new PageMargins(0, 0, 0, 0))));
    layout = layout.plusPage(new Page(new PageFormat(new Size2f(200, 100), new PageMargins(0, 0, 0, 0))));
    layout = layout.plusPage(new Page(new PageFormat(new Size2f(200, 200), new PageMargins(0, 0, 0, 0))));
    //create view
